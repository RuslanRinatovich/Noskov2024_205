    ...
    public partial class TypePage : Page
    {
        ...
        void LoadData()
        {
            try
            {
                ...
                List<Entities.Type> data = DataEntities.GetContext().Types.OrderBy(p => p.Title).ToList();
        ...
        private void BtnAddClick(object sender, RoutedEventArgs e)
        {
            try
            {
                TypeWindow window = new TypeWindow(new Entities.Type());
                if (window.ShowDialog() == true)
                {
                    DataEntities.GetContext().Types.Add(window.currentItem);
        ...
        private void BtnDeleteClick(object sender, RoutedEventArgs e)
        {
            ...
            Entities.Type selected = (sender as Button).DataContext as Entities.Type;
            ...
            if (messageBoxResult == MessageBoxResult.OK)
            {
                try
                {
                    ...
                    DataEntities.GetContext().Types.Remove(selected);
                    //сохраняем изменения
                    DataEntities.GetContext().SaveChanges();
        ...
        private void UpdateData()
        {
            ...
            var currentDatas = DataEntities.GetContext().Types.OrderBy(p => p.Title).ToList();
        ...
        private void BtnEdit_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                Entities.Type selected = DataGridGood.SelectedItem as Entities.Type;
                TypeWindow window = new TypeWindow(selected);
                if (window.ShowDialog() == true)
                {
