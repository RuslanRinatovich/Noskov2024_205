...
{
    /// <summary>
    /// Логика взаимодействия для FuelTypePage.xaml
    /// </summary>
    public partial class FuelTypePage : Page
    {
        ...
        void LoadData()
        {
            try
            {
                ...
                List<FuelType> data = DataEntities.GetContext().FuelTypes.OrderBy(p => p.Title).ToList();
        ...
        private void BtnAddClick(object sender, RoutedEventArgs e)
        {
            try
            {
                FuelTypeWindow window = new FuelTypeWindow(new FuelType());
                if (window.ShowDialog() == true)
                {
                    DataEntities.GetContext().FuelTypes.Add(window.currentItem);
        ...
        private void BtnDeleteClick(object sender, RoutedEventArgs e)
        {
            ...
            FuelType selected = (sender as Button).DataContext as FuelType;
            ...
            if (messageBoxResult == MessageBoxResult.OK)
            {
                try
                {
                    ...
                    DataEntities.GetContext().FuelTypes.Remove(selected);
                    //сохраняем изменения
                    DataEntities.GetContext().SaveChanges();
        ...
        private void UpdateData()
        {
            ...
            var currentDatas = DataEntities.GetContext().FuelTypes.OrderBy(p => p.Title).ToList();
        ...
        private void BtnEdit_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                FuelType selected = DataGridGood.SelectedItem as FuelType;
                FuelTypeWindow window = new FuelTypeWindow(selected);
                if (window.ShowDialog() == true)
                {
