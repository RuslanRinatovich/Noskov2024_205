    ...
    public partial class ColorsPage : Page
    {
        ...
        void LoadData()
        {
            try
            {
                ...
                List<Color> data = DataEntities.GetContext().Colors.OrderBy(p => p.Title).ToList();
        ...
        private void BtnAddClick(object sender, RoutedEventArgs e)
        {
            try
            {
                ColorWindow window = new ColorWindow(new Color());
                if (window.ShowDialog() == true)
                {
                    DataEntities.GetContext().Colors.Add(window.currentItem);
        ...
        private void BtnDeleteClick(object sender, RoutedEventArgs e)
        {
            ...
            Color selected = (sender as Button).DataContext as Color;
            ...
            if (messageBoxResult == MessageBoxResult.OK)
            {
                try
                {
                    ...
                    DataEntities.GetContext().Colors.Remove(selected);
                    //сохраняем изменения
                    DataEntities.GetContext().SaveChanges();
        ...
        private void UpdateData()
        {
            ...
            var currentDatas = DataEntities.GetContext().Colors.OrderBy(p => p.Title).ToList();
        ...
        private void BtnEdit_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                Color selected = DataGridGood.SelectedItem as Color;
                ColorWindow window = new ColorWindow(selected);
                if (window.ShowDialog() == true)
                {
