...
namespace CarShowRoom.Pages
{
    ...
    void LoadData()
    {
        try
        {
            ...
            List<Air> data = DataEntities.GetContext().Airs.OrderBy(p => p.Title).ToList();
    ...
    private void BtnAddClick(object sender, RoutedEventArgs e)
    {
        try
        {
            AirWindow window = new AirWindow(new Air());
            if (window.ShowDialog() == true)
            {
                DataEntities.GetContext().Airs.Add(window.currentItem);
    ...
    private void BtnDeleteClick(object sender, RoutedEventArgs e)
    {
        ...
        Air selected = (sender as Button).DataContext as Air;
        ...
        if (messageBoxResult == MessageBoxResult.OK)
        {
            try
            {
                ...
                DataEntities.GetContext().Airs.Remove(selected);
                //сохраняем изменения
                DataEntities.GetContext().SaveChanges();
    ...
    private void UpdateData()
    {
        ...
        var currentDatas = DataEntities.GetContext().Airs.OrderBy(p => p.Title).ToList();
    ...
    private void BtnEdit_Click(object sender, RoutedEventArgs e)
    {
        try
        {
            ...
            Air selected = DataGridGood.SelectedItem as Air;
            AirWindow window = new AirWindow(selected);
            if (window.ShowDialog() == true)
            {
